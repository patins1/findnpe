...
public class FirstFixHandler extends MarkerViewHandler {

	public FirstFixHandler() {
		// nothing to do
	}
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		return execute(view.getSelectedMarkers());
	}

	public Object execute(final IMarker[] ssl) throws ExecutionException {
	...
	private void doWork(IProgressMonitor monitor, IMarker[] ssl) {
